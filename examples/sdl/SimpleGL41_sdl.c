...
// ownership fight to route around the way examples/glfw/SimpleGL41.c's own
...
// TwKeyPressed(), same as examples/glfw/SimpleGL41.c's charCallback does
...
// examples/glfw/SimpleGL41.c's windowSizeCallback (registered as GLFW's
...
int main(void)
{
    ...
    // OpenGL 4.1 Core Profile, forward-compatible - same profile
    // examples/glfw/SimpleGL41.c targets.
    ...
    SDL_Window *window = SDL_CreateWindow("AntTweakBar + SDL3 (OpenGL 4.1 Core)", 800, 600,
    ...
    while (running) {
        ...
        // examples/glfw/SimpleGL41.c's glfwGetKey(window, GLFW_KEY_ESCAPE)
